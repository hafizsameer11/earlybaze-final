...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/easy_pdf_viewer/easy_pdf_viewer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/open_document/open_document.framework"
